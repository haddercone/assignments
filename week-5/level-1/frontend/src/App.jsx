...
function App() {
  ...
  return (
    <>
      <div className="min-h-screen flex p-4 flex-wrap justify-around items-center">
        <form
          className="flex h-full justify-center items-center flex-col gap-5 border border-gray-500 p-2 "
          ...
          >
            {!loading ? (
              "Create dev Profile"
                ...
                <span>Creating dev Profile &nbsp;</span>
